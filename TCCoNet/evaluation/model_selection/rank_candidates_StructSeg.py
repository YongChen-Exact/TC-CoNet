...
if __name__ == "__main__":
    ...
    overwrite_plans = {
        'TCCoNetTrainerV2_2': ["TCCoNetPlans", "TCCoNetPlans_customClip"], # r
        'TCCoNetTrainerV2_2_noMirror': ["TCCoNetPlans", "TCCoNetPlans_customClip"],  # r
        'TCCoNetTrainerV2_lessMomentum_noMirror': ["TCCoNetPlans", "TCCoNetPlans_customClip"],  # r
        'TCCoNetTrainerV2_2_structSeg_noMirror': ["TCCoNetPlans", "TCCoNetPlans_customClip"],  # r
        'TCCoNetTrainerV2_2_structSeg': ["TCCoNetPlans", "TCCoNetPlans_customClip"],  # r
        'TCCoNetTrainerV2_lessMomentum_noMirror_structSeg': ["TCCoNetPlans", "TCCoNetPlans_customClip"],  # r
        'TCCoNetTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder': ["TCCoNetPlans", "TCCoNetPlans_customClip"],  # r
        'TCCoNetTrainerV2_FabiansResUNet_structSet_NoMirror': ["TCCoNetPlans", "TCCoNetPlans_customClip"],  # r
        'TCCoNetTrainerV2_FabiansResUNet_structSet': ["TCCoNetPlans", "TCCoNetPlans_customClip"],  # r

    }

    trainers = ['TCCoNetTrainer'] + [
        'TCCoNetTrainerV2_2',
        'TCCoNetTrainerV2_lessMomentum_noMirror',
        'TCCoNetTrainerV2_2_noMirror',
        'TCCoNetTrainerV2_2_structSeg_noMirror',
        'TCCoNetTrainerV2_2_structSeg',
        'TCCoNetTrainerV2_lessMomentum_noMirror_structSeg',
        'TCCoNetTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder',
        'TCCoNetTrainerV2_FabiansResUNet_structSet_NoMirror',
        'TCCoNetTrainerV2_FabiansResUNet_structSet',
    ]
