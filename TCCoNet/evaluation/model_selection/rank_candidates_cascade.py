...
if __name__ == "__main__":
    ...
    plans = "TCCoNetPlansv2.1"

    overwrite_plans = {
        'TCCoNetTrainerCascadeFullRes': ['TCCoNetPlans'],
    }

    trainers = [
        'TCCoNetTrainerCascadeFullRes',
        'TCCoNetTrainerV2CascadeFullRes_EducatedGuess',
        'TCCoNetTrainerV2CascadeFullRes_EducatedGuess2',
        'TCCoNetTrainerV2CascadeFullRes_EducatedGuess3',
        'TCCoNetTrainerV2CascadeFullRes_lowerLR',
        'TCCoNetTrainerV2CascadeFullRes',
        'TCCoNetTrainerV2CascadeFullRes_noConnComp',
        'TCCoNetTrainerV2CascadeFullRes_shorter_lowerLR',
        'TCCoNetTrainerV2CascadeFullRes_shorter',
        'TCCoNetTrainerV2CascadeFullRes_smallerBinStrel',
        #'',
        #'',
        #'',
        #'',
