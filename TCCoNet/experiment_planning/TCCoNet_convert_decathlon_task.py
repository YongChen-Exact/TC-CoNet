...
from TCCoNet.experiment_planning.utils import split_4d
from TCCoNet.utilities.file_endings import remove_trailing_slash
...
def main():
    ...
    parser.add_argument("-i", help="Input folder. Must point to a TaskXX_TASKNAME folder as downloaded from the MSD "
                                   "website",default="/media/lab429/data1/CYCY/TCCoNet-main/DATASET/TCCoNet_raw/TCCoNet_raw_data/Task01_ACDC")
    ...
    parser.add_argument("-output_task_id", required=False, default=1, type=int,
