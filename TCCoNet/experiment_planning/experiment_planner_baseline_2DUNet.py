...
from TCCoNet.experiment_planning.common_utils import get_pool_and_conv_props
from TCCoNet.experiment_planning.experiment_planner_baseline_3DUNet import ExperimentPlanner
from TCCoNet.experiment_planning.utils import add_classes_in_slice_info
from TCCoNet.network_architecture.generic_UNet import Generic_UNet
from TCCoNet.paths import *
from TCCoNet.preprocessing.preprocessing import PreprocessorFor2D
...
class ExperimentPlanner2D(ExperimentPlanner):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(self.preprocessed_output_folder, "TCCoNetPlans" + "_plans_2D.pkl")
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        if batch_size < self.unet_min_batch_size:
            raise RuntimeError("This framework is not made to process patches this large. We will add patch-based "
                               "2D TransClawUNet later. Sorry for the inconvenience")
