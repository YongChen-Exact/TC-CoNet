...
def load_pretrained_weights(network, fname, verbose=False):
    ...
    # if state dict comes form nn.DataParallel but we use non-parallel TransNorm here then the state dict keys do not
    ...
    if ok:
        ...
        if verbose:
            print("Below is the list of overlapping blocks in pretrained TransNorm and TCCoNet architecture:")
