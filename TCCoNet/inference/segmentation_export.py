...
from TCCoNet.preprocessing.preprocessing import get_lowres_axis, get_do_separate_z, resample_data_or_seg
...
def save_segmentation_nifti_from_softmax(segmentation_softmax: Union[str, np.ndarray], out_fname: str,
    ...
    resampled to match that. This is generally useful because the spacings our TransClawUNet operate on are most of the time
