...
from TCCoNet.network_architecture.TCCoNet_heart import TCCoNet
...
class TCCoNetTrainerV2_TCCoNet_heart(TCCoNetTrainerV3):
    """
    Info for Fabian: same as internal nnUNetTrainerV3
    """
    ...
    def do_split(self):
        ...
        if self.fold == "all":
            ...
            splits[self.fold]['train'] = np.array(
                ['la_003', 'la_004', 'la_005', 'la_007',
                 'la_009', 'la_010', 'la_011', 'la_014',
                 'la_018', 'la_019', 'la_020', 'la_022',
                 'la_023', 'la_026', 'la_029', 'la_030'])
            splits[self.fold]['val'] = np.array(
                ['la_016', 'la_017', 'la_021', 'la_024'])
