...
import matplotlib
from TCCoNet.postprocessing.connected_components import determine_postprocessing
from TCCoNet.training.data_augmentation.default_data_augmentation import get_default_augmentation
from TCCoNet.training.dataloading.dataset_loading import DataLoader3D, unpack_dataset
from TCCoNet.evaluation.evaluator import aggregate_scores
...
from TCCoNet.inference.segmentation_export import save_segmentation_nifti_from_softmax
...
class TCCoNetTrainerCascadeFullRes(TCCoNetTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="TCCoNetTrainer", fp16=False):
        super(TCCoNetTrainerCascadeFullRes, self).__init__(plans_file, fold, output_folder, dataset_directory,
    ...
    def do_split(self):
        super(TCCoNetTrainerCascadeFullRes, self).do_split()
    ...
    def process_plans(self, plans):
        super(TCCoNetTrainerCascadeFullRes, self).process_plans(plans)
            ...
            if self.folder_with_preprocessed_data is not None:
                ...
                if self.unpack_data:
                    ...
                    print(
                        ...
                        "will wait all winter for your TransNorm to finish!")
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True,
        ...
        if run_postprocessing_on_folds:
            # in the old TCCoNet we would stop here. Now we add a postprocessing. This postprocessing can remove everything
