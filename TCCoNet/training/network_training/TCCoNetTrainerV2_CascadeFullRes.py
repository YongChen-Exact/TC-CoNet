...
from TCCoNet.training.network_training.TCCoNetTrainerV2 import TCCoNetTrainerV2
...
class TCCoNetTrainerV2CascadeFullRes(TCCoNetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="TCCoNetTrainerV2", fp16=False):
