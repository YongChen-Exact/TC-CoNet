...
import argparse
from TCCoNet.preprocessing.preprocessing import resample_data_or_seg
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class([join(TCCoNet.__path__[0], "training", "network_training")],
                                                trainerclass,
                                                "TCCoNet.training.network_training")
