...
def inference():
    label_list = sorted(glob.glob(os.path.join(
        r"G:/CY/CodesOfCy/new/TCCoNet-main/DATASET/TCCoNet_raw/TCCoNet_raw_data/Task02_Synapse/labelsTs",
        '*nii.gz')))
    dest_file = r"G:\CY\results\Third\Synapse\fold_0_unetr_pp_mulinput_ds_multiresblock_allcbam_para_resbridge\model_final_checkpoint"
    infer_list = sorted(
